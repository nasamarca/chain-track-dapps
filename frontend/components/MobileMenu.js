...
return (
        <div className="">
            ...
            <div className="z-20 fixed top-0 -left-96 lg:left-0 h-screen w-7/12 lg:w-72 bg-chainTColors-800/60 shadow-2xl peer-focus:left-0 peer:transition ease-out delay-300 duration-200 backdrop-blur-md">
